---
title: "Module 9: Risk, Probability & Uncertainty"
---
...
A p-value answers one question only: Could this observed difference simply be due to chance?
...
✅ The analysis suggests the **0.2% reduction** is unlikely to be explained by chance alone.
...
Those decisions require consideration of:

* the **size of the difference**
* the **confidence interval**
* the potential benefits and risks
* costs and resource implications
* the wider clinical and operational context
...
> "The difference is unlikely to be due to chance, but is it large enough to justify changing practice?"
