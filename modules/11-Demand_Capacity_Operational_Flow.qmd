...
As illustrated in the figure below, Improving one part of the pathway does not necessarily improve the whole pathway.
...
The waiting list is a stock, while RTT clock starts and RTT clock finishes are flows into and out of that stock.
