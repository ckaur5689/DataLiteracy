...
![](images/UnderstandingRTTandWaitingListDynamics.png){fig-align="center"}
...
Healthcare systems should be understood as **stocks and flows**, not simply as individual performance measures.

Improving one performance metric does not necessarily mean the overall healthcare system has improved.

Healthcare systems should be understood as **interconnected stocks and flows**, where changes in one part of the pathway often influence another.
...
If I remove pressure here, am I solving the system constraint—or simply moving it somewhere else?
:::
