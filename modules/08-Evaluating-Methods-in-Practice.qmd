...
| Evaluation Question | Typical Approaches |
|---------------------|-----------------------|
| **Did it work?** | RCTs, Interrupted Time Series, Difference-in-Differences |
| **How was it implemented?** | Process evaluation, implementation evaluation |
| **Why did it work (or not)?** | Qualitative research, Realist Evaluation |
| **Was it good value?** | Health economics, cost-effectiveness analysis |
| **Should we scale it?** | Mixed-method evaluation combining effectiveness, implementation and economic evidence |
