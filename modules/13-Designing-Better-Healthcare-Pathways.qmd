...
Pathway redesign is about far more than improving the performance of individual services. It involves rethinking how patients move through the healthcare system, identifying opportunities to remove unnecessary barriers, strengthening coordination between services and ensuring that every stage of the pathway contributes towards better health outcomes.
...
Although every healthcare pathway is unique, successful pathway redesign tends to share several common principles.

Figure 13.6 brings these principles together. It places the patient journey at the centre of pathway design and distinguishes between the principles that should guide every stage of care and the wider enablers that support the pathway as a whole.

The figure also illustrates an important point: good pathway design is not achieved by improving one stage in isolation. Patient-centred care, prevention, equity, evidence and coordination should influence the entire journey, while flow, consistency, technology, sustainable resource use and continuous learning enable the pathway to work effectively over time.

![](../images/Good-Pathway-Design.png)

*Figure 13.6: Good pathway design places the complete patient journey at the centre. Shared principles guide every stage of care, while system-wide enablers support efficient, equitable, sustainable and continuously improving pathways.*

Well-designed pathways typically aim to:
...
- use data, digital technology and AI where they add genuine value
- make sustainable use of workforce and financial resources
- generate evidence for continuous learning and improvement.

Rather than optimising individual parts of the system in isolation, pathway redesign seeks to improve the performance of the pathway as a whole.

Figure 13.6 summarises the principles that underpin effective pathway design. It illustrates how the patient journey sits at the centre of the pathway, surrounded by the principles that should guide every stage of care and the system-wide enablers that support high-quality, coordinated and sustainable healthcare delivery.

![](../images/Good-Pathway-Design.png)

*Figure 13.6: Good pathway design places the complete patient journey at the centre. Shared principles guide every stage of care, while system-wide enablers support efficient, equitable, sustainable and continuously improving pathways.*

Although these principles are interconnected, the starting point is always the patient journey itself. Effective pathway redesign begins by understanding what patients need, what they experience and what matters most to them.
...
From their perspective, there is no distinction between primary care, community services, hospitals or social care. They simply experience one journey through the health and care system.

Good pathway design therefore begins by understanding what matters most to patients.
...
::: {.callout-example collapse="false"}
## Example 13.7: Seeing the Pathway Through the Patient's Eyes
...
Patients are experts in experiencing healthcare pathways.

Frontline clinicians understand how care is delivered.

Managers understand operational constraints.

Analysts understand patterns within the data.

Each perspective provides valuable insight, but none is sufficient on its own.

Increasingly, pathway redesign adopts a **co-production** approach, bringing together patients, carers, clinicians, managers and analysts to develop shared solutions.
...
Combining these perspectives often leads to more practical and sustainable improvements than relying on quantitative data alone.
...
Patients, carers, clinicians, operational teams and analysts each understand different parts of the pathway. Bringing these perspectives together produces more effective and sustainable redesign.
:::
...
Preventative pathways often require investment before benefits become visible.
...
Healthcare should remain flexible enough to meet individual clinical needs and patient preferences.
...
Reducing unwarranted variation improves reliability while preserving appropriate clinical judgement.

Consistency should support personalised care rather than replace it.

### Improve Flow Across the Whole Pathway

Patients rarely experience delays because of one isolated service.

More commonly, delays occur at the boundaries between services, organisations or professional groups.

Examples include:

- referrals between primary and secondary care
- diagnostic waiting times
- delays arranging community services
- discharge planning
- communication between organisations
- follow-up after hospital discharge.

Improving patient flow therefore requires organisations to think beyond individual departments and consider how each stage of the pathway connects with the next.

Reducing unnecessary handovers, improving information sharing and simplifying transitions often produces greater improvements than optimising individual services in isolation.

Well-designed pathways create smoother journeys for patients while enabling staff to spend more time delivering care rather than managing fragmented processes.

Effective pathway redesign should therefore view flow as a property of the **whole system**, not simply the efficiency of individual organisations.