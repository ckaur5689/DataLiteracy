# Module 8 — Evaluation Methods in Practice
...
In Part 1 and Part 2 of this module, we explored:
...
Throughout this module, we have explored several approaches to strengthening confidence in evaluation findings.

One important principle is that **no single evaluation method answers every question**.

The most appropriate method depends on what you are trying to understand.

| Evaluation Question | Methods Commonly Used |
|---------------------|-----------------------|
| **Did it work?** | Randomised Controlled Trials (RCTs), Difference-in-Differences (DiD), Interrupted Time Series (ITS) |
| **How did it work?** | Process evaluation, implementation evaluation, qualitative interviews |
| **Why did it work (or not)?** | Qualitative research, Realist Evaluation, mixed-method evaluation |
| **Was it worth it?** | Health economics, cost-effectiveness analysis, cost-benefit analysis |
| **Should we scale it?** | Mixed-method evaluation, evidence synthesis, implementation evaluation |

::: {.callout-tip}
## Key Principle

Good evaluation starts with the **question**, not the method.
...
There is rarely a single "best" evaluation method—only methods that are more or less appropriate for the question being asked.
:::
