...
The confidence interval provides a range of values that are consistent with the observed data.
...
This means the observed result would be considered unlikely if there were actually no real difference.
