---
title: "Module 11: Demand, Capacity & Operational Flow"
---
...
As shown in @fig-demand-capacity-flow, each element continuously influences the others.

![Demand, Capacity and Flow are interdependent. Sustainable improvement requires balancing all three components.](images/Demand_Capacity_Flow_Triangle.png){#fig-demand-capacity-flow}
...
As illustrated in @fig-bottleneck, delays at a bottleneck propagate backwards through the system, creating queues upstream.

![A bottleneck creates queues upstream. Removing the bottleneck improves performance across the whole pathway.](images/Bottleneck_Upstream_Queues.png){#fig-bottleneck}
...
As demonstrated in @fig-arrival-patterns, both hospitals experience the same total demand, yet their operational experience is very different.

![Two hospitals can experience identical daily demand but very different operational pressure because of different arrival patterns.](images/Same_Demand_Different_Arrival_Patterns.png){#fig-arrival-patterns}
...
As illustrated in @fig-ripple-effect, improving one service may simply move pressure elsewhere unless the wider system is considered.

![Healthcare behaves as a connected system. Changes in one part of the pathway create ripple effects across the wider healthcare system.](images/Whole_System_Ripple_Effect.png){#fig-ripple-effect}
