...
people often make interpretation mistakes without realising it.
...
Here is the revised section with the image integrated naturally and the narrative tightened around it. The goal is for the image to feel like part of the teaching flow rather than a bolt-on.
...
Fast dashboard interpretation often jumps to conclusions based on colours, isolated metrics or single-month changes.

More thoughtful interpretation instead asks:

> **What context, comparison or explanation might sit behind the numbers?**

![](images/ReadingADashboard_1.png)
...
Dashboards are powerful because they help surface patterns.

However:

> **they do not automatically explain what those patterns mean**
...
may feel very different if the service saw:
...
dashboard interpretation becomes difficult.
...
> **what questions good decision-makers ask when reading dashboards**
