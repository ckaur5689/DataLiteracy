...
It simply tells us how compatible the observed data are with there being **no real difference**.
:::
...
✅ The 0.2% difference is **unlikely to be explained by chance alone**.

It **does not** tell us:

* whether a 0.2% reduction is clinically meaningful
* whether the intervention is cost-effective
* whether it should be implemented across the NHS

Those decisions require consideration of **effect size, confidence intervals, costs, risks and the wider context.**

Analysts sometimes report a **p-value** when comparing two groups or evaluating an intervention.

A p-value helps assess whether an observed difference is likely to have occurred by chance alone.

A commonly used threshold is:

> **p < 0.05**.

This suggests the observed difference is unlikely to be explained by chance alone.

Importantly, a p-value does **not** tell us:

* whether the intervention is important
* whether the effect is large
* whether the decision is worthwhile

A result can be statistically significant but have very little practical importance.

Small sample sizes often produce greater uncertainty, making it harder to distinguish genuine differences from random variation.

Similarly, a result that is not statistically significant may still be operationally important, particularly when evidence is limited or sample sizes are small.
...
> "The evidence is uncertain. We should also consider the size of the effect, the confidence interval, the sample size and the wider context."
...
> "The result may be statistically significant, but is the improvement meaningful enough to change practice?"
...
> "Confidence intervals help us understand uncertainty, but they should be interpreted alongside effect size, study design and the wider evidence."
