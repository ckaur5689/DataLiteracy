...
- fair comparison improves confidence in findings
- small numbers and short pilots can mislead
- some improvement may occur naturally over time
- stronger evaluation asks whether trajectories changed
- comparison groups improve confidence when randomisation is not practical
...
- Compared with what?
- Were the groups genuinely comparable?
- Could small numbers or short follow-up be misleading?
- Could improvement have happened naturally anyway?
- Did the trajectory meaningfully change?
- How confident are we that the intervention genuinely contributed to change?
